...
const getConfig = (defaultBranch, configName, logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    const config = yield github_action_config_helper_1.getConfig(configName, octokit, context);
    if (typeof config === 'boolean') {
        logger.error('"template" is required');
        throw new Error('Invalid config file');
    }
    try {
        return schema_1.validateSchema(defaultBranch, logger, Object.assign(Object.assign({}, default_config_1.DEFAULT_CONFIG), config));
    }
    catch (error) {

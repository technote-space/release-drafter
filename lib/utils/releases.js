...
exports.generateReleaseInfo = exports.findReleases = void 0;
...
const sortReleases = (releases) => {
    ...
    try {
        ...
        return releases.sort((r1, r2) => (new Date(ensureNotNull(r1.published_at))).getTimezoneOffset() - (new Date(ensureNotNull(r2.published_at))).getTimezoneOffset());
    }
};
const findReleases = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    const releases = yield octokit.paginate(octokit.repos.listReleases, {
...
const generateReleaseInfo = (commits, config, lastRelease, mergedPullRequests, version, tag, name) => {

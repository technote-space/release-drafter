...
exports.run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!draftRelease) {
        ...
        createOrUpdateReleaseResponse = yield octokit.repos.createRelease({
        ...
        createOrUpdateReleaseResponse = yield octokit.repos.updateRelease(Object.assign({ repo: context.repo.repo, owner: context.repo.owner, 'release_id': draftRelease.id, body: releaseInfo.body }, (draftRelease.tag_name ? { 'tag_name': draftRelease.tag_name } : null)));
    }
...
exports.run().catch(error => { console.log(error); core_1.setFailed(error.message); });
